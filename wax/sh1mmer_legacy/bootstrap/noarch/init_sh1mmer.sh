...
echo "Cr3nroll (Shim) is loading..."
echo "Sh1mmer Bootloader date: ${SCRIPT_DATE}"
echo "https://github.com/DMDCR/cr3nroll-shim"
echo ""
echo ""
...
if [ "$SKIP_SH1MMER_PATCH" -eq 0 ]; then
	echo "Copying Sh1mmer files... (For Cr3nroll, duh)"
